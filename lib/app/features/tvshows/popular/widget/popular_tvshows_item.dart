...
class PopularShowsItem extends ConsumerWidget {
  const PopularShowsItem({this.show, Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(DateFormat('MMM d, yyyy')
                          .format(show?.firstAirDate ?? DateTime.now())),
                    ),
                  ],
                ),
              ],
  ...
  userRatingWidget(Result show) {
    return Container(
      ...
      child: Center(
        child: Text(
          show.getVotingPercentage().toString() + '%',
          style: labelStyle,
        ),
      ),
    );
